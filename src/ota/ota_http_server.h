  ...
  namespace Modem
  {
    namespace Ota
    {
      ...
      private:
        ...
        volatile bool _githubReachable;
        volatile bool _githubCheckActive;
        volatile bool _githubCheckDone;
        bool _githubCheckArmed;
        volatile bool _githubCheckPublishPending;
      ...
      public:
        ...
        // force wird sofort neu bei GitHub nachgesehen. Antwort immer über
        // onFirmwareStatus – aus dem Cache oder später aus dem Check-Task.
        void requestFirmwareStatus(bool force);
        std::function<void(const FirmwareStatus &)> onFirmwareStatus;
      };
    }
  }
}